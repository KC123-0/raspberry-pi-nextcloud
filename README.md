...
> All IP addresses, credentials, and personal details have been replaced with placeholders. Replace `your-pi-name` with your Pi's hostname throughout.
...
- nvme0n1 → slash — OS, Docker, config
...
- Nextcloud failed login count checked (brute force detection)
